...
namespace Heliacal
{
    public partial class oknoHraNeptun : Form
    {
        public oknoHraNeptun()
        {
            InitializeComponent();
        ...
        public bool tlacitko36Spravne = false;
        public bool tlacitko37Spravne = false;
        public bool tlacitko38Spravne = false;
        public bool tlacitko39Spravne = false;
        public bool tlacitko40Spravne = false;
        public bool tlacitko41Spravne = false;
        ...
        public void ZkontrolujDokonceni()
        {
            ...
            if (tlacitko36.Top == 500 && tlacitko36.Left == 500)
            {
                tlacitko36Spravne = true;
            }
            if (tlacitko37.Top == 600 && tlacitko37.Left == 0)
            {
                tlacitko37Spravne = true;
            }
            if (tlacitko38.Top == 600 && tlacitko38.Left == 100)
            {
                tlacitko38Spravne = true;
            }
            if (tlacitko39.Top == 600 && tlacitko39.Left == 200)
            {
                tlacitko39Spravne = true;
            }
            if (tlacitko40.Top == 600 && tlacitko40.Left == 300)
            {
                tlacitko40Spravne = true;
            }
            if (tlacitko41.Top == 600 && tlacitko41.Left == 400)
            {
                tlacitko41Spravne = true;
            }
            ...
            if (tlacitko1Spravne && tlacitko2Spravne && tlacitko3Spravne && tlacitko4Spravne && 
                ...
                tlacitko33Spravne && tlacitko34Spravne && tlacitko35Spravne && tlacitko36Spravne &&
                tlacitko37Spravne && tlacitko38Spravne && tlacitko39Spravne && tlacitko40Spravne &&
                tlacitko41Spravne)

            {

                timerNeptun.Enabled = false;

                int pocetTahu = Convert.ToInt32(labelPocetTahu.Text);
                int casc = Convert.ToInt32(labelCas.Text);
                int skore = 80000 / (pocetTahu + casc);
                tridaPromenne.posledniCas = casc;
                tridaPromenne.posledniPocetTahu = pocetTahu;

                if (skore > Properties.Settings.Default.skoreNeptun)
                {
                    Properties.Settings.Default.skoreNeptun = skore;
                }

                tridaPromenne.skorePosledni = skore;

                TextWriter tw = new StreamWriter("skoreNeptun.txt");
                tw.WriteLine(Convert.ToString(Properties.Settings.Default.skoreNeptun));
                tw.Close();

                TextWriter wt = new StreamWriter("neptunVyplneny.txt");
                wt.WriteLine("OK");
                wt.Close();

                if (tridaPromenne.neptunVyplneny == false)
                {
            ...
            else
            {
                ...
                tlacitko36Spravne = false;
                tlacitko37Spravne = false;
                tlacitko38Spravne = false;
                tlacitko39Spravne = false;
                tlacitko40Spravne = false;
                tlacitko41Spravne = false;
        ...
        public void Zamichej()
        {
            ...
            for (int i = 0; i < 1000; i++)
            {
                ...
                int stisknuti41 = nahoda.Next(0, 2);
                tlacitko = tlacitko41;
                if (stisknuti41 == 1)
                {
                    Stiskni();
                }
                int stisknuti40 = nahoda.Next(0, 2);
                tlacitko = tlacitko40;
                if (stisknuti40 == 1)
                {
                    Stiskni();
                }
                int stisknuti39 = nahoda.Next(0, 2);
                tlacitko = tlacitko39;
                if (stisknuti39 == 1)
                {
                    Stiskni();
                }
                int stisknuti38 = nahoda.Next(0, 2);
                tlacitko = tlacitko38;
                if (stisknuti38 == 1)
                {
                    Stiskni();
                }
                int stisknuti37 = nahoda.Next(0, 2);
                tlacitko = tlacitko37;
                if (stisknuti37 == 1)
                {
                    Stiskni();
                }
                int stisknuti36 = nahoda.Next(0, 2);
                tlacitko = tlacitko36;
                if (stisknuti36 == 1)
                {
                    Stiskni();
        ...
        private void tlacitkoHrat_Click(object sender, MouseEventArgs e)
        {
            ...
            tlacitko36.Enabled = true;
            tlacitko37.Enabled = true;
            tlacitko38.Enabled = true;
            tlacitko39.Enabled = true;
            tlacitko40.Enabled = true;
            tlacitko41.Enabled = true;



            tlacitkoDira.Enabled = true;
            tlacitkoHrat.Enabled = false;
            timerNeptun.Enabled = true;
        ...
        private void timerNeptun_Tick(object sender, EventArgs e)
        {
        ...
        private void tlacitko36_Click(object sender, EventArgs e)
        {
            tlacitko = tlacitko36;
            Stiskni();
            ZkontrolujDokonceni();
        ...
        private void tlacitko37_Click(object sender, EventArgs e)
        {
            tlacitko = tlacitko37;
            Stiskni();
            ZkontrolujDokonceni();
        ...
        private void tlacitko38_Click(object sender, EventArgs e)
        {
            tlacitko = tlacitko38;
            Stiskni();
            ZkontrolujDokonceni();
        ...
        private void tlacitko39_Click(object sender, EventArgs e)
        {
            tlacitko = tlacitko39;
            Stiskni();
            ZkontrolujDokonceni();
        ...
        private void tlacitko40_Click(object sender, EventArgs e)
        {
            tlacitko = tlacitko40;
            Stiskni();
            ZkontrolujDokonceni();
        ...
        private void tlacitko41_Click(object sender, EventArgs e)
        {
            tlacitko = tlacitko41;
            Stiskni();
            ZkontrolujDokonceni();
